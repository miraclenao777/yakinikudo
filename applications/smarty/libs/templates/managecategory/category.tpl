...
<div id="container">
<div id="main">
<h2>カテゴリ：{$param.category.name}</h2>
<a href="/managecategory/ins1/category_cd/{$param.category.cd}/">新規登録</a><br>
...
{foreach from=$param.item key=k item=v}    
    <tr>
        ...
        <td align="left"><a href="/managecategory/upd1/category_cd/{$param.category.cd}/cd/{$v.cd}/">{$v.name}</a></td>   
...
<a href="/managecategory/">カテゴリトップ</a><br>
