...
{/if}
<form action="/tools/spotimg2/" method="POST" ENCTYPE="MULTIPART/FORM-DATA">
...
<table width="580" border="1">
    ...
    <tr>
        ...
        <td align="center">
{if $param.img_flg==1}
<IMG SRC="/images/spot/{$param.cd}.jpg" width="{$param.width}" height="{$param.height}" alt="{$param.name}"><br>
<a href="/tools/spotimgunlink/cd/{$param.cd}/">画像を削除する。</a>
{else}
画像なし
{/if}       
        </td>        
